...
public class GameField extends JFrame {
    ...
    static public Lesson11_Refactoring.Cell[][] playField;
    ...
    public GameField() throws HeadlessException {
        ...
        Lesson11_Refactoring.MyComponent myComponent = new Lesson11_Refactoring.MyComponent();
...
//                    }
    ...
    private  static void genMatrix (){
         playField = new Lesson11_Refactoring.Cell[COLS][ROWS];
         int count = 0;
         for (int x=0; x< COLS; x++) {
             for (int y=0; y< ROWS; y++) {
                playField[x][y] = new Lesson11_Refactoring.Cell(count, x,y,"closed");
                count++;
             }
         }
        ...
        for (int x=0; x< COLS; x++) {
            for (int y=0; y< ROWS; y++) {
                if (!playField[x][y].isStatusBomb()){
                    ...
                    switch (bombsNearby){
                        case 0: playField[x][y].setCellImage(Lesson11_Refactoring.Box.ZERO.toString().toLowerCase());
                            break;
                        case 1 : playField[x][y].setCellImage(Lesson11_Refactoring.Box.NUM1.toString().toLowerCase());
                            break;
                        case 2 : playField[x][y].setCellImage(Lesson11_Refactoring.Box.NUM2.toString().toLowerCase());
                            break;
                        case 3 : playField[x][y].setCellImage(Lesson11_Refactoring.Box.NUM3.toString().toLowerCase());
                            break;
                        case 4 : playField[x][y].setCellImage(Lesson11_Refactoring.Box.NUM4.toString().toLowerCase());
                            break;
                        case 5 : playField[x][y].setCellImage(Lesson11_Refactoring.Box.NUM5.toString().toLowerCase());
                            break;
                        case 6 : playField[x][y].setCellImage(Lesson11_Refactoring.Box.NUM6.toString().toLowerCase());
                            break;
                        case 7 : playField[x][y].setCellImage(Lesson11_Refactoring.Box.NUM7.toString().toLowerCase());
                            break;
                        case 8 : playField[x][y].setCellImage(Lesson11_Refactoring.Box.NUM8.toString().toLowerCase());
                            break;
                    }
                }
            }
