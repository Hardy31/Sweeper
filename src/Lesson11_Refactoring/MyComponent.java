...
public class MyComponent extends JComponent {
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int x = 0; x< Lesson11_Refactoring.GameField.COLS ; x++) {
            for (int y = 0; y< Lesson11_Refactoring.GameField.ROWS; y++) {
...
//                }
                ...
                if (!GameField.playField[x][y].isStatusClosed() ){
                    ...
                    g.drawImage(getImage(Lesson11_Refactoring.GameField.playField[x][y].getCellImage()), x*50,y*50, null);
...
//        g.drawImage(getImage("flaged"),((int)xCord/50)*50,(((int)yCord-30)/50)*50, null);
    ...
    private int bombNearbu(int x, int y){
        return Lesson11_Refactoring.GameField.playField[x][y].getBombsNearby();
